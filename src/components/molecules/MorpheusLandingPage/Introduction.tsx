					...
					<Box>
						...
						>
							<Typography variant="sub_title">
								Enable Web3 Transformation and Process
								Automation with our
							</Typography>
						</Box>
						<Box>
				...
				>
					<Box
						sx={{
							...
							alignItems: 'end',
							background:
								'linear-gradient(160deg, #D7E0FF 0%, #FFF 100%)',
						...
						onClick={() =>
							window.open(`${process.env.REACT_APP_WF_URL}`)
						}
					>
						<Typography variant="sub_title">
							Start Process
					...
					<Box
						sx={{
							...
							alignItems: 'end',
							background:
								'linear-gradient(160deg, #DCFFD7 0%, #FFF 100%)',
							backdropFilter: 'blur(2px)',
							'&:hover': {
								cursor: 'pointer',
							},
					...
					<Box
						sx={{
							...
							alignItems: 'end',
							background:
								'linear-gradient(160deg, #FFFBD7 0%, #FFF 100%)',
							backdropFilter: 'blur(2px)',
							'&:hover': {
								cursor: 'pointer',
							},
						...
						onClick={() =>
							window.open(`${process.env.REACT_APP_SC_URL}`)
						}
					>
						<Typography variant="sub_title">
							Create <br />
